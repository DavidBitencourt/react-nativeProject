...
export default class App extends Component {
  ...
  fetcUser() {
    ...
    return axios.get('https://reqres.in/api/users/' + idUser).then(({data}) => {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.containerTitle}>Detalhes do usuário</Text>
        </View>
        <View style={styles.userContainer}>
          ...
          <TouchableHighlight style={styles.button} onPress={() => this.exit()}>
